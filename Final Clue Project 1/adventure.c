...
int main() {
    ...
    //used to create the item, character, and location names.
    char *a[9];
    a[0] = "Ballroom";
    a[1] = "Conservatory";
    a[2] = "Billiard Room";
   ...
   //Used to create all the items, characters and the board
	...
	correct->item = itemList[rand()%9];
	correct->character = characterList[rand()%9];
        ...
        for (int i = 0; i < 9; i++){
            if (board[i]->flag == true) {
                ...
                for (int j = 0; j < 9; j++){
                    ...
                    if (strcmp(characterList[j]->name, guess) == 0){
                        v = j;
                        break;
                    }
                }
    ...
    while (win != true && guessCounter < 10){
        ...
        if (strcmp(input, "help\n") == 0 || strcmp(input, "Help\n") == 0){
            ...
            for (int i = 0; i < 9; i++){
                ...
                if (i == 8){
                    printf("Please type in a valid item name from the room. Type in break if you want to go see what's in the room using 'look'.\n");
                    scanf("%s", &input);
                    i = 0;
                }
                if (board[i]->flag == true && item_in_list(board[i]->itemList, input) /* && strcmp(input,board[i]->itemList->name) == 0*/ ){
                    for (int j = 0; j < 9; j++) {
            ...
            for (int i = 0; i < 9; i++){
                ...
                if (i == 8){
                    printf("Please type in a valid item name from your inventory. Type in 'break' if you want to go see what's in your inventory using 'inventory'.\n");
                    scanf("%s", &input);
                    i = 0;
                }
