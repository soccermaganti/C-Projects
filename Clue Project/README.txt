...
- Basically a 3x3 board/matrix where you always start in the bottom left corner.
- Can traverse through the rooms by following the pointers and the game will stop you if you try to go into a NULL direction.
- For game input, just make sure to type in Item names and Character names by their exact casing as shown in 'list' or 'look';
- For commands, just make sure everything is in lowercase and you should be good.
